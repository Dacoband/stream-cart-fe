...
function Page() {
  ...
  useEffect(() => {
    ...
    fetchData();
  }, [status, sort, stock, page, user?.shopId]);
  useEffect(() => {
          ...
          <div className="w-full">
            <Table>
              <TableHeader className="bg-[#B0F847]/50">
                <TableRow>
                  <TableHead className="font-semibold pl-6">Sản phẩm</TableHead>
                    ...
                    <TableRow key={product.id}>
                      <TableCell className="pl-5 w-[400px]">
                        <div className="flex items-start gap-4  h-24 py-2">
                          <Image
                            src={
                              product.primaryImageUrl || "/assets/emptydata.png"
                            }
                            height={80}
                            width={80}
                        ...
                        {productVariants[product.id]?.variants?.length > 0 && (
